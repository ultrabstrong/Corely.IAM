...
internal class SetConnection() : CommandBase("set-connection", "Set the database connection string")
{
    ...
    protected override Task ExecuteAsync()
    {
        if (string.IsNullOrEmpty(ConnectionString))
        {
            ...
            Info("Usage: config set-connection \"Server=localhost;Port=3306;Database=mydb;...\"");
        ...
        try
        {
            ...
            var connectionStrings = jsonNode["ConnectionStrings"]?.AsObject() ?? new JsonObject();
