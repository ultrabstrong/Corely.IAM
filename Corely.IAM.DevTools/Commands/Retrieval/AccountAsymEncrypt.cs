...
{
    internal class AccountAsymEncrypt : CommandBase
    {
        ...
        public AccountAsymEncrypt(
            IRetrievalService retrievalService,
            IAuthenticationService authenticationService
        )
            : base(
                "account-asym-encrypt",
                "Asymmetric encryption operations using an account's key",
        ...
        protected override async Task ExecuteAsync()
        {
            ...
            var result = await _retrievalService.GetAccountAsymmetricEncryptionProviderAsync(
                Guid.Parse(Id)
            );
