...
{
    internal class ListPermissions : CommandBase
    {
        ...
        public ListPermissions(
            ...
            : base("list-permissions", "List permissions")
        {
        ...
        protected override async Task ExecuteAsync()
        {
            ...
            var result = await _retrievalService.ListPermissionsAsync(
                new ListPermissionsRequest(Guid.Parse(AccountId), Skip: Skip, Take: Take)
            );
