...
{
    internal class UserAsymEncrypt : CommandBase
    {
        ...
        public UserAsymEncrypt(
            ...
            : base(
                "user-asym-encrypt",
                "Asymmetric encryption operations using the current user's key",
        ...
        protected override async Task ExecuteAsync()
        {
            ...
            var result = await _retrievalService.GetUserAsymmetricEncryptionProviderAsync();
