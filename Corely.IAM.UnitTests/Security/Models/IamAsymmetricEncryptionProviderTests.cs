...
public class IamAsymmetricEncryptionProviderTests
{
    private readonly Mock<IAsymmetricEncryptionProvider> _mockProvider = new();
    private readonly Mock<IAsymmetricKeyStoreProvider> _mockKeyStore = new();
    private readonly IamAsymmetricEncryptionProvider _iamProvider;

    public IamAsymmetricEncryptionProviderTests()
    {
