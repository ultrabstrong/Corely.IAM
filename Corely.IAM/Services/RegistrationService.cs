...
) : IRegistrationService
{
    ...
    public async Task<RegisterUserResult> RegisterUserAsync(RegisterUserRequest request)
    {
        ...
        try
        {
            ...
            _userContextProvider.SetUserContext(new IamUserContext(userResult.CreatedId, 0));
    ...
    public async Task<RegisterGroupResult> RegisterGroupAsync(RegisterGroupRequest request)
    {
        ...
        var result = await _groupProcessor.CreateGroupAsync(
            new(request.GroupName, request.OwnerAccountId)
        );
    ...
    public async Task<RegisterRoleResult> RegisterRoleAsync(RegisterRoleRequest request)
    {
        ...
        var result = await _roleProcessor.CreateRoleAsync(
            new(request.RoleName, request.OwnerAccountId)
        );
